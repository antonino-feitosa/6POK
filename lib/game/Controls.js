    ...
    .requires(
        ...
        Controls = ig.Class.extend({
            ...
            processMenuInput: function () {
                if (this.hasActiveMenu && ig.input.pressed('menu_statistics')) {
                ...
                } else if(this.hasActiveFeedback && ig.input.pressed('interact')){
                    this.ent_feedback.kill();
                    this.ent_feedback = null;
                    this.hasActiveFeedback = false;
                }
                return this.hasActiveMenu || this.hasActiveFeedback;
            },
