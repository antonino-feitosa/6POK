        ...
        Move = ig.Class.extend({
            ...
            _processTargetType(look) {
                ...
                if (this.target & TARGET.ENEMY) {
                    ...
                    targets.all.push(... targets.enemies);
                }
        ...
        MoveList = ig.Class.extend({
            ...
            init(animal) {
                if (!MoveList.lists[animal.name]) {
                    ...
                    let list = [];
                    list.push(... rand.sample(start, 4));
                    list.push(... rand.sample(leveling, 12));
                    list.push(... rand.sample(others, 6));
                    list.push(... rand.sample(end, 8));
