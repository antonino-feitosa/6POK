...
.defines(function(){
    ...
    ig.global.mapMemory = {map: LevelModelStart, next: null, previous: null};
    ...
    LevelModelSmallResources = ig.global.tilesetName.map(name => new ig.Image(name));
...
MyGame = HexGame.extend({
	...
	init: function() {
		...
		this.loadLevel(LevelModelStart);
        //loadLevelDeferred
	},
