        ...
        wm.EditMap = ig.BackgroundMap.extend({
            ...
            draw: function () {
                ...
                if (this.active) {
                    ...
                    ig.system.context.strokeRect(
                        ...
                        this.height * this.tilesize * 3 / 4 * ig.system.scale + 1
                    );
                }
            },
            ...
            drawCursor: function (x, y) {
                if (this.isSelecting) {
                    ...
                    var cy = Math.floor((y + this.scroll.y) / (this.tilesize * 3 / 4)) * this.tilesize * 3 / 4 - this.scroll.y - co.y;

                    let gridy = Math.floor((y + this.scroll.y) / (this.tilesize * 3 / 4)) - co.y;
                    if (gridy % 2 === 0) {
                        cx += this.tilesize / 2;
                    }
